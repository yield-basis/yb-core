...
# --- YB market stack (LT + AMM + Curve twocrypto pool) -----------------------
# Shared by the leveraged-trading (tests/lt) and net-pressure (tests/net_pressure)
# suites. Session-scoped and lazy: only deployed when a test first requests them.
